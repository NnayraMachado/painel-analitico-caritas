...
- **📊 Dashboard Executivo:** Visão com indicadores mensais comparativos (Month-over-Month), distribuição de público por sexo (gênero) e classificação automatizada da natureza do atendimento (Coletivas, Individuais, Demandas Espontâneas e Parcerias).
